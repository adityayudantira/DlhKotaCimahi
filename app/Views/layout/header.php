...
<head>
    ...
    <script src="<?= base_url() ?>/assets/vendor/js/metisMenu.min.js"></script>

    <!-- DataTables JavaScript -->
    <script src="<?= base_url() ?>/assets/vendor/js/dataTables/jquery.dataTables.min.js"></script>
    <script src="<?= base_url() ?>/assets/vendor/js/dataTables/dataTables.bootstrap.min.js"></script>

    <script src="<?= base_url() ?>/assets/vendor/js/leaflet.js"></script>
