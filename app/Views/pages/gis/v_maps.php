	...
	<div id="map" style="width: 100%; height: 740px;"></div>
		<script>
			...
			<?php foreach ($titikPantau as $key => $value) { ?>
				...
				"<b> Foto: </b>" + "<img src='<?= base_url('/assets/img/'.$value['foto']) ?>' width='100%' height='100%'>" +
				"<b> Video: </b>" + "<video src='<?= base_url('/assets/img/'.$value['video']);?>' type='video/mp4' width='100%' height='100%' controls></video>"           
				);
			<?php } ?>
