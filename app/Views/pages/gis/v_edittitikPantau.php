                        ...
                        <div class="panel panel-default">
                            ...
                            <div class=panel-body>
                                ...
                                <div class="col d-flex flex-column gap-4">
                                    ...
                                    <div><img src="<?= base_url('assets/img/'.$titikPantau['foto']) ?>" width="150px" height="150px"> <br/></div>

                                    <div class="d-flex justify-content-between align-items-center container__create">
                                        <h4>Video</h4>
                                        <input type="file" name="video" class="form-control">
                                    </div>
                                    <div><video src="<?= base_url('/assets/img/'.$titikPantau['video']) ?>" width="200px" height="100px"></video></div>
